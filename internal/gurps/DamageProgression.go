...
func (p DamageProgression) MarshalText() (text []byte, err error) {
	return []byte(p.Key()), nil
}

// UnmarshalText implements encoding.TextUnmarshaler.
func (p *DamageProgression) UnmarshalText(text []byte) error {
	*p = DamageProgressionFromString(string(text))
	return nil
}
