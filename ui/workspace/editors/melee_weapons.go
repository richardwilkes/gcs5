...
func newMeleeWeaponsPanel(entity *gurps.Entity, modifierParent fmt.Stringer, weapons []*gurps.Weapon) *meleeWeaponsPanel {
	p := &meleeWeaponsPanel{
		entity:         entity,
