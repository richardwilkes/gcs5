...
func (p *condModProvider) DuplicateSelection(_ *unison.Table[*ntable.Node[*gurps.ConditionalModifier]]) {
}

func (p *condModProvider) DeleteSelection(_ *unison.Table[*ntable.Node[*gurps.ConditionalModifier]]) {
}
