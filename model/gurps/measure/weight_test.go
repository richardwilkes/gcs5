...
func TestWeightConversion(t *testing.T) {
	assert.Equal(t, "1 lb", measure.Pound.Format(measure.WeightFromInt(1, measure.Pound)))
	assert.Equal(t, "15 lb", measure.Pound.Format(measure.WeightFromInt(15, measure.Pound)))
	assert.Equal(t, "0.5 kg", measure.Kilogram.Format(measure.WeightFromInt(1, measure.Pound)))
	assert.Equal(t, "7.5 kg", measure.Kilogram.Format(measure.WeightFromInt(15, measure.Pound)))
