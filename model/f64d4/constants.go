...
var (
	...
	NegFour       = fixed.F64d4FromInt64(-4)
	NegThree      = fixed.F64d4FromInt64(-3)
	NegTwo        = fixed.F64d4FromInt64(-2)
	...
	Three         = fixed.F64d4FromInt64(3)
	Five          = fixed.F64d4FromInt64(5)
	Six           = fixed.F64d4FromInt64(6)
	Ten           = fixed.F64d4FromInt64(10)
	Nineteen      = fixed.F64d4FromInt64(19)
